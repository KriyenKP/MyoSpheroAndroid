...
public class MainActivity extends Activity {
    ...
    private void createHub() {
        Toast.makeText(context, "attempting Hub creation.", Toast.LENGTH_SHORT).show();

        Hub hub = Hub.getInstance();

        if (!hub.init(this)) {

            Toast.makeText(context, "Could not initialize the Hub.", Toast.LENGTH_SHORT).show();
            ...
            public void onPose(Myo myo, long timestamp, Pose pose) {
                ...
                switch (pose) {
                    ...
                    case REST:
                        ...
                        if(BB8ConnectionActivity.getRobot() != null)
                            BB8ConnectionActivity.getRobot().drive((float) 0, (float) 0);
                        break;
                    ...
                    case FINGERS_SPREAD:
                        ...
                        if(BB8ConnectionActivity.getRobot() != null)
                            BB8ConnectionActivity.getRobot().drive((float) 0, (float) 100);
